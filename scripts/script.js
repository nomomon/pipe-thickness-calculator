...
function solve_pipe() {
    ...
    const { s, p_raschet } = pipe_thickness({ D_a, c, p, metal, metal_grade, t });
...
function solve_tap() {
    ...
    const { s, p_raschet } = tap_thickness({ tap_type, D_a, R, c, p, metal, metal_grade, t });
...
function solve_transiter() {
    ...
    const { s, p_raschet } = transiter_thickness({ transiter_type, D_1, D_2, l, c, p, metal, metal_grade, t });
...
function solve_tee() {
    ...
    const { s, p_raschet } = tee_thickness({ tee_type, D_a, d, c, p, metal, metal_grade, t });
...
function solve_plug() {
    ...
    const { s, p_raschet } = plug_thickness({ plug_type, D_a, d, r_i, D, D_b, b, h, c, p, metal, metal_grade, t });
...
function get_sol_params() {
    ...
    const pipe = pipe_thickness({ D_a, c, p, metal, metal_grade, t }, true);
    ...
    const tap = tap_thickness({ tap_type, D_a, R, c, p, metal, metal_grade, t }, true);
    ...
    const transiter = transiter_thickness({ transiter_type, D_1, D_2, l, c, p, metal, metal_grade, t }, true);
    ...
    const tee = tee_thickness({ tee_type, D_a, d, c, p, metal, metal_grade, t }, true);
    ...
    const plug = plug_thickness({ plug_type, D_a, d, r_i, D, D_b, b, h, c, p, metal, metal_grade, t }, true);
